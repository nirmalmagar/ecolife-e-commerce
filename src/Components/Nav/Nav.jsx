                ...
                <div className='flex mx-5 mt-3 mb-2 justify-between font-robota font-medium text-sm text-gray-500'>
                    ...
                    <div className={`${menuIcon ? "-left-80" : "left-0 z-10"} duration-300  lg:static lg:uppercase absolute lg:ml-0 top-0`}>
                        <ul ref={MenuRef} className='lg:flex lg:flex-row w-80 lg:w-full h-screen fixed lg:h-full text-[16px] lg:static font-bold pt-2  bg-white flex-col '>
                            ...
                            <li className='xl:mr-12 mr-8 pl-10 pb-2'><NavLink className='hover:text-textColor' to="/">Home</NavLink></li>
                            ...
                            <li className='xl:mr-12 mr-8 pl-10 lg:pt-0 pt-2'><NavLink className='hover:text-textColor' to="/shop">Shop</NavLink></li>
                            ...
                            <li className='xl:mr-12 mr-8  pl-10'><NavLink className='hover:text-textColor' to="/contact-us">Contact us</NavLink></li>
                            <li className='xl:mr-12 mr-8 pl-10 py-2 lg:my-0 my-2 lg:border-none lg:py-0 border-y-2'><NavLink className='hover:text-textColor' to="/about-us">About us</NavLink></li>
                        </ul>
                    </div>
                    <div className='mt-2 relative'>
                        ...
                        <div className='relative left-16 bottom-8'>
                            <code className='absolute top-[2px] text-white font-semibold left-[8px]'>0</code>
