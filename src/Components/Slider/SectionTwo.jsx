...
import bgTwo from '../../assets/images/section/bgSecond.jpg'
const SectionTwo = () => {
  return (
    <>
      <div className='relative'>
        <div className='overflow-x-clip h-screen w-screen bg-cover bg-center bg-no-repeat'
          style={{ backgroundImage: `url(${bgTwo})` }}></div>
        <div className='absolute top-0 font-lato ml-[15%] md:ml-[32%] lg:mt-[17%] mt-[23%] text-center'>
          {/* <div className='absolute top-0  ml-[32%] mt-[14%]'> */}
          <div>
